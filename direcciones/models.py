...
class Direccion(models.Model):
    ...
    user_ptr_id = models.ForeignKey(User, models.DO_NOTHING, db_column='user_ptr_id')
    id_comuna = models.ForeignKey(Comuna, models.DO_NOTHING, db_column='id_comuna')
    
    def __str__(self):
        return '%s, %s, %s, %s' % (self.desc_direccion, self.numero, self.desc_block_depto, self.id_comuna)
